...
const CACHE='chvostikovo-portal-shell-20260920-install-auth-fix-v76';
...
const SHELL=['/','/styles.css?v=20260920-install-auth-fix-v76','/app.js?v=20260920-install-auth-fix-v76'];
