...
const CACHE='chvostikovo-portal-shell-20260919-session-install-v72';
...
const SHELL=['/','/styles.css?v=20260919-session-install-v72','/app.js?v=20260919-session-install-v72'];
