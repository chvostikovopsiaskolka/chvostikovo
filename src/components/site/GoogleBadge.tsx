export function GoogleBadge({ className = "" }: { className?: string }) {
  return (
    <div
      className={`inline-flex max-w-full items-center gap-x-1.5 rounded-full bg-card/90 px-3 py-1.5 shadow-soft backdrop-blur-sm sm:gap-x-2 sm:px-4 sm:py-2 ${className}`}
    >
