...
const APP_BUILD='20260926-customer-email-confirm-v109';
...
(function customerDogProfilePreview(){
  ...
  function applyHero(){
    ...
    const legacyCopy=[...hero.children].find(el=>el.tagName==='DIV'&&!el.classList.contains('hero-dog-v36')&&el.querySelector('p'));
    legacyCopy?.remove();
